...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../packages/expo-dev-support/ios/Resources/EXDevMenuApp.js"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/EXDevSupport/EXDevSupport.bundle"
