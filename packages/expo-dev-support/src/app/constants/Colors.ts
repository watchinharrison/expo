...
export default {
  light: {
    ...
    menuBackground: '#f5f5f7',
    menuAppInfoBackground: '#fff',
    menuAppInfoBorder: '#ddd',
    menuItemBackground: '#fff',
    menuItemBorderColor: '#ddd',
    menuItemText: '#000020',
  },
  dark: {
    absolute: '#000',
    ...
    menuBackground: '#000',
    menuAppInfoBackground: '#000',
    menuAppInfoBorder: '#000',
    menuItemBackground: '#1c1c1e',
    menuItemBorderColor: '#303033',
    menuItemText: '#fff',
  },
};
