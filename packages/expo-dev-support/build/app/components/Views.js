...
export const Separator = (props) => {
    let theme = useTheme();
    let { style, ...otherProps } = props;
    return (<View style={[styles.separator, { backgroundColor: Colors[theme].separator }, style]} {...otherProps}/>);
};
...
export const StyledButton = (props) => {
    ...
    return (<TouchableNativeFeedbackSafe background={TouchableNativeFeedbackSafe.Ripple(rippleColor, false)} style={[
        {
            backgroundColor,
            borderColor,
        },
