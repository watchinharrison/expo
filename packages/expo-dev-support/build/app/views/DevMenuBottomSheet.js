...
class DevMenuBottomSheet extends React.PureComponent {
    constructor() {
        ...
        this.snapPoints = [0, Math.max(BottomSheet.renumber('50%'), 600), '90%'];
        ...
        this.renderHeader = () => {
            return (<View style={styles.bottomSheetHeader}>
    ...
    render() {
        return (<DevMenuBottomSheetContext.Provider value={this.providedContext}>
        <View style={styles.bottomSheetContainer}>
          <TouchableWithoutFeedback onPress={this.collapseAndClose}>
            <Animated.View style={[styles.bottomSheetBackground, { opacity: this.backgroundOpacity }]}/>
          </TouchableWithoutFeedback>
          <BottomSheet ref={this.ref} initialSnap={0} enabledInnerScrolling={false} overdragResistanceFactor={1.5} snapPoints={this.snapPoints} callbackNode={this.callbackNode} renderHeader={this.renderHeader} renderContent={this.renderContent} onCloseEnd={this.onCloseEnd}/>
        </View>
