...
import { Dimensions, Platform, StyleSheet, Text, TouchableOpacity as TouchableOpacityRN, View, } from 'react-native';
...
class DevMenuOnboarding extends React.PureComponent {
    ...
    render() {
        ...
        return (<View style={styles.onboardingContainer}>
        <StyledView style={styles.onboardingBackground} lightBackgroundColor="#fff" darkBackgroundColor="#000"/>
